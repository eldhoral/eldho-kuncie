...
import (
	...
	aboutService "bitbucket.org/bitbucketnobubank/paylater-cms-api/internal/about/service"
...
type HTTPHandler struct {
	...
	AboutService aboutService.Service
}

//NewHTTPHandler creates new http handler
func NewHTTPHandler(base *handler.BaseHTTPHandler,
	abService aboutService.Service) *HTTPHandler {
	return &HTTPHandler{App: base,
		AboutService: abService}
}
