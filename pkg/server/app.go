...
const (
	...
	Yii2ExceptionResponseType        // For MobileBadRequest and Method NotAllowMethod response
...
type Yii2HTTPExceptionResponse struct {
...
func (r Response) GetYii2Exception() interface{} {
	return r.Data
}
